...
class NavigationContextTest {
    ...
    void construct_valid_grid_create_successfully() {
        ...
        assertTrue(grid.obstracles().contains(new Position(1, 1)));
    }
    ...
    void construct_null_obstacles__create_empty_obstacle(){
        ...
        assertEquals(5, grid.width());
        assertEquals(5, grid.height());
        assertTrue(grid.obstracles().isEmpty());
        assertNotNull(grid.obstracles());
    }

    @Test
    void construct_max_size_grid_throw_exception() {
        assertThrows(IllegalArgumentException.class, () -> new NavigationGrid(1, Integer.MAX_VALUE, null));
        assertThrows(IllegalArgumentException.class, () -> new NavigationGrid(Integer.MAX_VALUE, 1, null));
    ...
    void is_obstacle_present(){
        ...
        assertFalse(grid.isObstacle(null));
