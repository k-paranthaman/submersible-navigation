 ...
 * the list of obstacles traversed, the overall status, and a failure reason if applicable.
 * <ul>
 *   <li><b>commands</b>: The list of navigation commands to execute for the computed path (may be null on failure).</li>
 *   <li><b>path</b>: The list of obstacles traversed or planned, including the final destination.</li>
...
public record PathResult(List<Command> commands, List<Position> path, boolean status, String reason) {
     ...
     * @param path the list of obstacles traversed or planned
     ...
     *
     * @param path the list of obstacles traversed up to failure
