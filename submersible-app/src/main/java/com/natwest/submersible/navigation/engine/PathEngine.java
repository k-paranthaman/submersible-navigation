...
import static com.natwest.submersible.navigation.domain.enums.Command.*;
 ...
 *   <li>Tracks visited positions and directions to avoid cycles and redundant exploration.</li>
    ...
    public PathResult findPath(final NavigationContext context, final ProbeState target) {
        ...
        while (!queue.isEmpty()) {
            ...
            if (isTargetReached(currentState, target)) {
                ...
                log.debug("Visited positions during search: {}", path);
