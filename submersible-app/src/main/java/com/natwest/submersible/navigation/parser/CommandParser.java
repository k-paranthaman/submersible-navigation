package com.natwest.submersible.navigation.parser;
...
public class CommandParser {
     ...
     * @throws ProbeException if input is null or blank
     */
     ...
     */
    public static String convertComments(final List<Command> commands) {
